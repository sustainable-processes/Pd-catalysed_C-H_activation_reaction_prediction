...
The third automated script in the electrophilic addition mechanism (Pd(OAc)+ added as an electrophile)
...
if os.path.isfile(logfiles[1]):
    ...
    log_data_updated2 = log_data2.log_processing(1, scratch, cluster)
