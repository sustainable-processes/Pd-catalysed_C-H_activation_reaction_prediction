...
The last automated script in the electrophilic addition mechanism (Pd(OAc)2 added as an electrophile)
...
for flsdf in glob.glob(cur_dir + "/*.sdf"):
    ...
    if step1_data.finished and step2_data.finished:
        ...
        energy_intermediate = logfile2.minimal_energy_molecule_list(0, scratch, cluster)
        difference = energy_intermediate - energy_molecule
        results = logfile2.intermediates_result_builder(molecule, 0, scratch, cluster)
